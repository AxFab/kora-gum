...
typedef struct gum_win32_window gum_win32_window_t;
struct gum_win32_window {
    HWND hwnd;
    HDC hdc;
    int x, y;
    PAINTSTRUCT ps;
...
void gum_text_size(gum_cell_t *cell, int *w, int *h, GUM_skin *skin) {}
...
//hmap_t fonts_map;
//
//void *gum_load_font(gum_window_t *win, gum_skin_t *skin)
//{
//    wchar_t name[52];
...
//}
//
//void *gum_fetch_font(gum_window_t*win, gum_skin_t *skin)
//{
//    if (!fonts_init) {
...
//}
//
//gum_window_t*gum_create_surface(int width, int height)
//{
//    if (!win32_init)
//        gum_win32_setup();
...
//
//
//    gum_window_t*win = (gum_window_t *)malloc(sizeof(gum_window_t));
//    win->hwnd = hwnd;
...
//}
//
//void gum_destroy_surface(gum_window_t*win)
//{
//    ReleaseDC(win->hwnd, win->hdc);
//}
//
//gum_window_t*gum_surface(gum_window_t*parent, int width, int height)
//{
...
//}
//
//void gum_fill_context(gum_window_t *win, GUM_gctx *ctx)
//{
//    RECT rect;
...
//int gum_event_poll(gum_window_t *win, gum_event_t *event, int timeout)
//{
//    MSG msg;
...
//
//
//void gum_push_event(gum_window_t *win, int type, size_t param0, size_t param1, void *data)
//{
...
///* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-= */
//
//void gum_do_visual(gum_cell_t *cell, gum_window_t *win, GUM_rect *inval)
//{
//    RECT r;
//    r.left = inval->left;
//    r.right = inval->right;
...
//}
//
//void gum_resize_win(gum_window_t *win, int width, int height)
//{
//}
//
//void gum_text_size(const char *text, int *w, int *h, gum_skin_t *skin)
//{
//    *h = 10;
//    *w = strlen(text) * 8;
//}
...
//}
//
//void gum_draw_pic(gum_window_t *win, gum_window_t *sub, GUM_box *box, GUM_anim *anim)
//{
//    // TODO -- animation
//    BITMAP bm;
...
//}
//
//void gum_draw_img(gum_window_t *win, HBITMAP bmp, GUM_box *box)
//{
//    // TODO -- animation
//    BITMAP bm;
...
//
//
//void gum_draw_cell(gum_window_t *win, gum_cell_t *cell, bool top)
//{
//    gum_skin_t *skin = gum_skin(cell);
//    if (skin == NULL)
//        return;
//
...
//}
//
//void gum_draw_scrolls(gum_window_t *win, gum_cell_t *cell)
//{
//}
//
